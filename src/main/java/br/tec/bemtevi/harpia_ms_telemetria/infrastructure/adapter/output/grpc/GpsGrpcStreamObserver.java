...
public class GpsGrpcStreamObserver implements StreamObserver<GpsGrpc.Void> {
    private final LoggerFacade loggerFacade;

    public GpsGrpcStreamObserver(LoggerFacade loggerFacade) {
        this.loggerFacade = loggerFacade;
    }

    @Override
    public void onNext(GpsGrpc.Void value) {

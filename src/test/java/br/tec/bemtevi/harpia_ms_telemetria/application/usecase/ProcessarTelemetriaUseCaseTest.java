...
//        HarpiaSensors harpiaSensors = new HarpiaSensors(List.of(lte), List.of(gps), List.of(temperature));
//        HarpiaTelemetryMessage harpiaTelemetryMessage = new HarpiaTelemetryMessage("H-1234", harpiaSensors);
//        processarTelemetriaUseCase.execute(harpiaTelemetryMessage);
//
